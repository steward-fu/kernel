...
#line 96 "util/pmu-bison.c" /* yacc.c:337  */
# ifndef YY_NULLPTR
...
union YYSTYPE
{
#line 30 "util/pmu.y" /* yacc.c:352  */

	unsigned long num;
	DECLARE_BITMAP(bits, PERF_PMU_FORMAT_BITS);

#line 152 "util/pmu-bison.c" /* yacc.c:352  */
};
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, struct list_head *format, char *name)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (format);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, struct list_head *format, char *name)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, format, name);
  YYFPRINTF (yyo, ")");
}
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 44 "util/pmu.y" /* yacc.c:1652  */
    {
	ABORT_ON(perf_pmu__new_format(format, name,
				      PERF_PMU_FORMAT_VALUE_CONFIG,
				      (yyvsp[0].bits)));
}
#line 1251 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 5:
#line 51 "util/pmu.y" /* yacc.c:1652  */
    {
	ABORT_ON(perf_pmu__new_format(format, name,
				      PERF_PMU_FORMAT_VALUE_CONFIG1,
				      (yyvsp[0].bits)));
}
#line 1261 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 6:
#line 58 "util/pmu.y" /* yacc.c:1652  */
    {
	ABORT_ON(perf_pmu__new_format(format, name,
				      PERF_PMU_FORMAT_VALUE_CONFIG2,
				      (yyvsp[0].bits)));
}
#line 1271 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 7:
#line 66 "util/pmu.y" /* yacc.c:1652  */
    {
	bitmap_or((yyval.bits), (yyvsp[-2].bits), (yyvsp[0].bits), 64);
}
#line 1279 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 8:
#line 71 "util/pmu.y" /* yacc.c:1652  */
    {
	memcpy((yyval.bits), (yyvsp[0].bits), sizeof((yyvsp[0].bits)));
}
#line 1287 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 9:
#line 77 "util/pmu.y" /* yacc.c:1652  */
    {
	perf_pmu__set_format((yyval.bits), (yyvsp[-2].num), (yyvsp[0].num));
}
#line 1295 "util/pmu-bison.c" /* yacc.c:1652  */
    break;

  case 10:
#line 82 "util/pmu.y" /* yacc.c:1652  */
    {
	perf_pmu__set_format((yyval.bits), (yyvsp[0].num), 0);
}
#line 1303 "util/pmu-bison.c" /* yacc.c:1652  */
    break;


#line 1307 "util/pmu-bison.c" /* yacc.c:1652  */
      default: break;
    }
...
#line 86 "util/pmu.y" /* yacc.c:1918  */
